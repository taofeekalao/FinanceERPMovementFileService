...
*******************************************************************
    ...
    REPORT.CHECKER = "BALANCE_REPORT_CHECK_":R.DATES(EB.DAT.LAST.WORKING.DAY):'_':SESSION.NO:".csv"
    OPENSEQ F.BACKUP, REPORT.CHECKER TO REPORT.CHECKER.PATH ELSE
        CALL OCOMO ("Cannot Open Flat File")
    END

    CHECKER.HEADER = "BRANCH":"|":"CURRENCY":"|":"ERP.ACCOUNT.NUMBER":"|":"CONSOLE.KEY":"|":"FCY CLOSING.BALANCE":"|":"LCY CLOSING.BALANCE":"|":"KEY TYPE":"|":"WORK ID":"|":"ERP ID"
    WRITESEQ CHECKER.HEADER TO REPORT.CHECKER.PATH ELSE CHECKER.HEADER = ""
