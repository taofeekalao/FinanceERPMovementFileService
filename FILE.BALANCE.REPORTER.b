...
******************
	...
	*	Set Headers
    FINAL.REC<-1> = "Status Code,Ledger ID,Effective Date of Transaction,Period,Journal Source,Journal Category,Currency Code,Journal Entry Creation Date,Actual Flag,Company,CostCenter,Branches,Account,LoB,Intercompany,Sector of activities,Institutional sector,Future1,Future2"
	
	*	18 Columns Up To Here

    FINAL.REC<-1> = "Entered Debit Amount,Entered Credit Amount,Converted Debit Amount,Converted Credit Amount,Refrence1_Batch_Name,Reference2_Batch_Description,Reference4_Journal Entry Name,Reference5_Journal Entry Description,Reference6_Journal Entry Reference,Reference7_Journal Entry Reversal,Reference8_Journal Entry Reversal Period,Reference9_Journal Entry Reversal Method,Reference10_Journal Entry Line Description,Statistical Amount,Currency Conversion Type,Currency Conversion Date, Interface Group Indentifier,Context field for Journal Entry Line DFF"
